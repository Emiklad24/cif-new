...
const LaboratoryInformation = ({ form }) => {
  ...
  const dateResultReleased = formValues?.dateResultReleasedPcr ? true : false;
  const isEditHFUser = userRole === USER_ROLE.EDIT && userFacilityId;
  const hasDateResultReleased = true
  // isEditHFUser && dateResultReleased;
  console.log(dateResultReleased, "dateResultReleased", hasDateResultReleased)
