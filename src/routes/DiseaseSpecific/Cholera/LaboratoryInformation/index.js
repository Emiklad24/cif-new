...
import { QUERY_PARAM, USER_ROLE } from "constants/ActionTypes";
...
const LaboratoryInformation = ({ form }) => {
  ...
  const dateResultReleased =
    formValues?.dateResultReleasedStool ||
    formValues?.dateResultReleasedRDT ||
    formValues?.dateResultReleasedRectalSwab ||
    formValues?.dateResultReleasedRectalSwabMicroscopy;
  ...
  const isEditHFUser =
    userRole === USER_ROLE.EDIT && userFacilityId ? true : false;
  const canEditHFUserView = isEditHFUser && hasDateResultReleased;

  console.log(canEditHFUserView, "canSeeResult", canSeeResult);
  ...
  return (
    <>
      {/* {canSeeResult || canEditHFUserView ? ( */}
                    ...
                    <>
                      ...
                      {formValues?.stoolSwabSpecimenReceived === "YES" && (
                        <>
                          ...
                          {(formValues?.typeOfTestDoneStool?.includes(
                            "culture"
                          ) ||
                            formValues?.typeOfTestDoneStool?.includes(
                              "rdt"
