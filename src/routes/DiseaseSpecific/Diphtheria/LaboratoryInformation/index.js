    ...
    <>
      <Collapse defaultActiveKey={["1"]} onChange={onChange}>
        <Panel header="Laboratory information" key="1">
          ...
          subTitle="The result will be entered by the laboratory"
            ...
            <Col lg={12} md={12} sm={24}>
              ...
              >
                <Radio.Group buttonStyle="solid">
                  ...
                  <Radio.Button value="noGrowth">No growth</Radio.Button>
                </Radio.Group>
              </Form.Item>
            </Col>
            ...
            <Col lg={12} md={12} sm={24}>
              <Form.Item
                label="Organism Cultured?"
                name="organismCultured"
                labelCol={{ span: 24 }}
                wrapperCol={{ span: 24 }}
                rules={[
                  {
              ...
              >
                <Radio.Group buttonStyle="solid">
                  <Radio.Button value="corynebacteriumDiphtheriae">
                    C.diphtheriae
                  </Radio.Button>
                  <Radio.Button value="corynebacteriumUlcerans">
                    C.ulcerans
                  </Radio.Button>
                  <Radio.Button value="corynebacteriumPseudotuberculosis">
            ...
            <Col lg={12} md={12} sm={24}>
              <Form.Item
                label="Toxigenic Test Result (ELEK/PCR Result)"
                name="toxigenicTestResult"
                labelCol={{ span: 24 }}
                wrapperCol={{ span: 24 }}
                rules={[
                  {
