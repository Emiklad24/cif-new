...
const testingLaboratoryData = ['National Reference Laboratory', 'Central Public health laboratory ','Maitama district hospital laboratory',];
            ...
            <Col lg={12} md={12} sm={24}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Select Specimen condition",
                  },
                ]}
              >
                <Radio.Group buttonStyle="solid">
