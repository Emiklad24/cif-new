        ...
        <Panel header="Laboratory information" key="1">
          ...
          <Row>
            <Col lg={12} md={12} sm={24}>
              ...
              >
                <Radio.Group buttonStyle="solid" onChange={(e) => handleUpdateInputValues(e.target.name, e.target.value)} name="specimenReceived" >
                  <Radio.Button value="yes">Yes</Radio.Button>
                  <Radio.Button value="no">No</Radio.Button>
                </Radio.Group>
              </Form.Item>
            ...
            formValues?.specimenReceived === "yes" && (
              <>
                <Row>
                  ...
                  <Col lg={12} md={8} sm={24}>
                    <Form.Item
                      ...
                      <CheckboxGroup
                        ...
                        name="typeOfSpecmenReceived"
                        onChange={(value) => handleUpdateInputValues("typeOfSpecmenReceived", value)}
                      />
                    </Form.Item>
                  </Col>
                  ...
                  {
                    isArray(formValues?.typeOfSpecmenReceived) && formValues?.typeOfSpecmenReceived?.length !== 0 && (
                      ...
                      <Col lg={12} md={8} sm={24}>
                        <Form.Item
                          ...
                          <CheckboxGroup
                            options={
                              isArray(formValues?.typeOfSpecmenReceived) && formValues?.typeOfSpecmenReceived?.length === 3 ?
                                ...
                                isArray(formValues?.typeOfSpecmenReceived) && formValues?.typeOfSpecmenReceived?.length === 1 && formValues?.typeOfSpecmenReceived?.includes("blood") ?

                                  [
                                    { label: 'Serology', value: 'Serology' },

                                  ] :
                                  isArray(formValues?.typeOfSpecmenReceived) && formValues?.typeOfSpecmenReceived?.length === 2 && (formValues?.typeOfSpecmenReceived?.includes("swab") || formValues?.typeOfSpecmenReceived?.includes("crust")) && formValues?.typeOfSpecmenReceived?.includes("blood") ?

                                    [
                                      { label: 'Serology', value: 'Serology' },
                                      { label: 'PCR', value: 'PCR' }
                                    ] :
                                    isArray(formValues?.typeOfSpecmenReceived) && formValues?.typeOfSpecmenReceived?.length === 2 && formValues?.typeOfSpecmenReceived?.includes("swab") && formValues?.typeOfSpecmenReceived?.includes("crust") ?

                                      [
                                        { label: 'PCR', value: 'PCR' }
                                      ] :

                                      isArray(formValues?.typeOfSpecmenReceived) && formValues?.typeOfSpecmenReceived?.length === 1 && (formValues?.typeOfSpecmenReceived?.includes("crust") || formValues?.typeOfSpecmenReceived?.includes("swab")) ?
                ...
                {
                  isArray(formValues?.typeOfTestConducted) && formValues?.typeOfTestConducted?.includes("PCR") && (
                    <Row>
                      <Col lg={12} md={12} sm={24}>
                        <Form.Item
                ...
                {
                  isArray(formValues?.typeOfTestConducted) && formValues?.typeOfTestConducted?.includes("Serology") && (
